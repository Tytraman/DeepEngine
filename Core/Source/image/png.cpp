...
namespace deep {
	...
	*/
	...
	====================
	*/
	const char *png::colorTypeName(image_color_type colorType)
	{
		switch(colorType)
        {
			default:
				return "Unknown";
			case image_color_type::None:
				return "None";
			case image_color_type::Palette:
				return "Palette";
			case image_color_type::Gray:
				return "Grayscale";
			case image_color_type::RGB:
				return "RGB";
			case image_color_type::RGBA:
				return "RGBA";
			case image_color_type::GA:
				return "GA";
		}
	}
