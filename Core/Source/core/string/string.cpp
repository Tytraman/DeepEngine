...
namespace deep
{
    ...
    */
    ...
    ===================
    */
    size_t string::replace_all(char toReplace, char replacement)
    {
        char *ptr = m_Chars.get();

        size_t num = string_utils::replace_all(ptr, toReplace, replacement);
        m_Chars.assign(ptr);
    ...
    */
    ...
    {
        size_t length = m_String->get_length();
