...
namespace deep
{
    ...
    class string
    {
        ...
        public:
            ...
            DE_API bool append(const string &str);

            DE_API size_t replace_all(char toReplace, char replacement);
            ...
            DE_API size_t get_length() const;
    ...
    */
    ...
    ==============
    */
    inline bool string::append(const string &str)
    {
        return append(add_const<uint8_t *>(str.str()), str.get_length());
    }
    ...
    */
    ...
    {
        if(m_Position < m_String->get_length())
        {
            m_Position++;
            return true;
        }
