...
void main()
{
    ...
    vec3 ambient = deLight.ambient * vec3(texture(deMaterial.diffuse, texCoords));
    vec3 diffuse = deLight.diffuse * diff * vec3(texture(deMaterial.diffuse, texCoords));      // Intensité de la couleur de diffusion.
